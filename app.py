# -*- coding: utf-8 -*-
"""Updated app.py with sys.path debugging

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1x6eCIQ6wPRkxLnvnHMWzvHDGdnVPuanR
"""
...
import os  # Import os for current working directory debugging

# --- Start Debugging Lines ---
# These lines will print the current working directory and Python's sys.path
# to your deployment logs when the application starts.
print(f"[{datetime.now().strftime('%Y-%m-%d %H:%M:%S')}] Current working directory: {os.getcwd()}")
print(f"[{datetime.now().strftime('%Y-%m-%d %H:%M:%S')}] Python sys.path: {sys.path}")
# --- End Debugging Lines ---
